...
public interface IEntityType{
	 ...
	 * @param packageName Package name for the Entity Type
	 */
	 ...
	 * @param name Name for the Entity Type
	 * @throws EsfingeAOMException
	 */
	 ...
	 * @param propertyType Property Type to be added
	 * @throws EsfingeAOMException
	 */
	 ...
	 * @param propertyType Property Type to be removed
	 * @throws EsfingeAOMException
	 */
	...
	/**
	 * Removes a Property Type from this Entity Type
	 * @param propertyName Name of the Property Type to be removed
	 * @throws EsfingeAOMException
	 */
	 ...
	 * @param name Name of the Property Type to be returned
