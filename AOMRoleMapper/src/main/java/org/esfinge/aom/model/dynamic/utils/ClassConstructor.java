...
public class ClassConstructor{	
	...
	public static MethodVisitor createComplexPropertyGetter(String name, ClassWriter cw,
		...
		mv.visitVarInsn(ALOAD, 1);
		mv.visitMethodInsn(INVOKEVIRTUAL, adapterFactoryPath + "AdapterFactory", "generate", "(Lorg/esfinge/aom/api/model/IEntity;)Ljava/lang/Object;", false);
		mv.visitTypeInsn(CHECKCAST, propertyType.replace(".", "/"));
		mv.visitLabel(l1);
		mv.visitInsn(ARETURN);
		mv.visitLabel(l2);
	...
	public static void createComplexPropertySetter(String name, ClassWriter cw,
		...
		mv.visitVarInsn(ALOAD, 2);
		mv.visitMethodInsn(INVOKEINTERFACE, "org/esfinge/aom/api/model/IProperty", "setValue", "(Ljava/lang/Object;)V", true);
		mv.visitLabel(l1);
