...
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytest.Account;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytest.AccountProperty;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytest.AccountPropertyType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytest.AccountType;

public class AdapterPropertyTest {

	private static final String accountPropertyClass = "net.sf.esfinge.aom.rolemapper.core.testclasses.propertytest.AccountProperty";
