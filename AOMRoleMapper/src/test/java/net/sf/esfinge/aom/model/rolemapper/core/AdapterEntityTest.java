...
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytest.Account;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytest.AccountProperty;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytest.AccountPropertyType;
...
public class AdapterEntityTest {
	...
	private static final String accountClass = "net.sf.esfinge.aom.rolemapper.core.testclasses.entitytest.Account";
	private static final String accountTypeClass = "net.sf.esfinge.aom.rolemapper.core.testclasses.entitytest.AccountType";
	private static final String accountPropertyTypeClass = "net.sf.esfinge.aom.rolemapper.core.testclasses.entitytest.AccountPropertyType";
