...
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.Account;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.AccountPropertyType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.AccountType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.AccountTypeFixedProperties;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.AccountTypeWithMetadataMap;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.AccountTypeWithoutAnnotations;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.IAccountType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.MetadatasAccountType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.SimpleAccountType;

import org.junit.Test;

public class AdapterEntityTypeTest {

	private static final String accountTypeClass = "net.sf.esfinge.aom.rolemapper.core.testclasses.entitytypetest.AccountType";
