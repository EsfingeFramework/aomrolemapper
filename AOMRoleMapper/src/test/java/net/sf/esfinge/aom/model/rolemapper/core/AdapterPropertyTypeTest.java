...
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytypetest.Account;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytypetest.AccountPropertyType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytypetest.AccountPropertyTypeWithMetadataMap;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytypetest.AccountType;
import net.sf.esfinge.aom.rolemapper.core.testclasses.propertytypetest.MetadatasAccountPropertyType;

public class AdapterPropertyTypeTest {

	private static final String accountPropertyTypeClass = "net.sf.esfinge.aom.rolemapper.core.testclasses.propertytypetest.AccountPropertyType";
