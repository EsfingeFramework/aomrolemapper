...
Inclua o JAR do AOMNeo4jPersistenceFramework no ClassPath da aplicação
...
Isso é feito pois o Neo4j não possui coleções e assim no caso de um
...
As chaves utilizadas para identificação nos documentos Neo4j são obrigatoriamente
